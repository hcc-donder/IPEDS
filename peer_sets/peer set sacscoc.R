...
# manually edit to customize choices
    ...
    # dashboard
    my_peers <- c(175519,176354,198039,198206,198914,199421,199449,199467,199625,217615,217712,226408) # e.g. my_peers <- c(123457,232567) 
    my_peers_only <- TRUE
